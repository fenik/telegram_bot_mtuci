...
def answer(message):
    if message.text.lower() == "попробуй":
        ...
        bot.send_message(message.chat.id, 'Фильмы серии "Властелин Колец"\n<https://yandex.ru/search/?clid=2358536'
                                          ...
                                          'Гария '
                                          'Поттер\n<https://yandex.ru/search/?text=трилогия+гарри+поттер+смотреть+онлайн&lr=213&clid=2358536>\n\nСерия "Пираты Карибского моря"\n<https://yandex.ru/search/?text=пираты+карибского+моря+смотреть+онлайн&lr=213&clid=2358536>\n\nЕсли вам не понравилось, что я предложил, можете посмотреть туть👇\n<https://www.kinopoisk.ru/lists/movies/genre--fantasy/?sort=votes&b=foreign>')
        return start(message)
    elif message.text.lower() == "боевик":
        bot.send_message(message.chat.id, 'Терминатор\n<https://yandex.ru/search/?text=терминатор+смотреть+онлайн&lr=213&clid=2358536&src=suggest_B>\n\nДжентельмены\n<https://yandex.ru/search/?text=джентльмены+смотреть+онлайн&lr=213&clid=2358536&src=suggest_W>\n\nГладиатор\n<https://yandex.ru/search/?text=гладиатор+смотреть+онлайн&lr=213&clid=2358536&src=suggest_T>\n\nХраброе сердце\n<https://yandex.ru/search/?text=храброе+сердце+смотреть+онлайн&lr=213&clid=2358536>\n\nЕсли вам не понравилось, что я предложил, можете посмотреть туть👇\n<https://www.kinoafisha.info/rating/movies/action/>')
        return start(message)
    elif message.text.lower() == "триллеры":
        bot.send_message(message.chat.id, 'Адвокат дьявола\n<https://yandex.ru/search/?clid=2358536&text=адвокат+дьявола+смотреть+онлайн&l10n=ru&lr=213>\n\nКрестный отец\n<https://yandex.ru/search/?text=крёстный+отец+смотреть+онлайн&lr=213&clid=2358536&src=suggest_B>\n\nДом Gucci\n<https://yandex.ru/search/?text=дом+гуччи+смотреть+онлайн&lr=213&clid=2358536&src=suggest_B>\n\nОстров проклятых\n<https://yandex.ru/search/?text=остров+проклятых+смотреть+онлайн&lr=213&clid=2358536&src=suggest_B>\n\nКод Да Винчи\n<https://yandex.ru/search/?text=код+да+винчи+смотреть+онлайн&lr=213&clid=2358536>\n\nЕсли вам не понравилось, что я предложил, можете посмотреть туть👇\n<https://www.kinopoisk.ru/lists/movies/genre--thriller/?sort=votes&b=high_rated&b=films>')
        return start(message)
    elif message.text.lower() == "комедия":
        bot.send_message(message.chat.id, 'Один дома\n<https://yandex.ru/search/?text=один+дома+смотреть+онлайн&lr=10719&clid=2358536&src=suggest_B>\n\nОперация «Ы» и другие приключения Шурика\n<https://yandex.ru/search/?text=операция+ы+и+другие+приключения+шурика+смотреть+онлайн&lr=10719&clid=2358536&src=suggest_B>\n\n1+1\n<https://yandex.ru/search/?text=1%2B1+смотреть+онлайн+&lr=10719&clid=2358536>')
        return start(message)
